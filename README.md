...
This data analysis portfolio project showcasing the analysis of marketing data to determine the cohort value of a product's global free trial promotion. The project involves summarizing and aggregating data to calculate key metrics using SQL and a PostgreSQL database.
